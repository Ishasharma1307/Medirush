...
export const PrescriptionUploader = ({ file, onChange }) => {
  ...
  return (
    <div>
      ...
      >
        ...
        <p className="font-extrabold text-gray-800 text-base mb-1.5 relative z-10">{dragging ? 'Drop your prescription here' : 'Tap to upload or drag & drop'}</p>
